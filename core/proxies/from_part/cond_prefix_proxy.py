...
class FromCondPrefixNetProxy(ModuleProxy):
    def _init_train(self, base_net, target_net, part_name, file_name, tensor=False):
        ...
        with open(DLSet.main_folder_link % 'Validation' + '/From/X_gt_sup_prefix', 'r') as f:
            info = json.load(f)
    ...
    def __init__(self, base_net, predict_mode=False, train_data_holder=None,
        ...
        super(FromCondPrefixNetProxy, self).__init__(predict_mode, train_data_holder, valid_data_holder, test_data_holder, thres=0.81)
