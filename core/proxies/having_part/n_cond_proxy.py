...
class HavingNCondNetProxy(ModuleProxy):
    ...
    def __init__(self, base_net, predict_mode=False, train_data_holder=None,
        ...
        super(HavingNCondNetProxy, self).__init__(predict_mode, train_data_holder, valid_data_holder, test_data_holder)
        self._init_env(base_net, NCondNet, 'Having', 'N', True)
