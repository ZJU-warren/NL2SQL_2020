...
class WhereCondSuffixNetProxy(ModuleProxy):
    ...
    def __init__(self, base_net, predict_mode=False, train_data_holder=None,
        ...
        super(WhereCondSuffixNetProxy, self).__init__(predict_mode, train_data_holder, valid_data_holder, test_data_holder)
    ...
    def predict(self, top=1, keyword=None, target_path=None):
        result = super().predict(self.prefix_N, 'prefix', '/Where/suffix')
